(function (c, n) {
  ...
  c.fn.imagesLoaded = function (f) {
    ...
    function j(b, a) {
      b.src === l || -1 !== c.inArray(b, k) || (k.push(b), a ? h.push(b) :
        i.push(b), c.data(b, "imagesLoaded", {
          isBroken: a,
          src: b.src
        }), o && d.notifyWith(c(b), [a, e, c(i), c(h)]), e.length === k.length &&
    ...
    e.length ? e.bind("load.imagesLoaded error.imagesLoaded", function (b) {
      ...
      else if (a.complete && a.naturalWidth !== n) j(a, 0 === a.naturalWidth ||
        0 === a.naturalHeight);
